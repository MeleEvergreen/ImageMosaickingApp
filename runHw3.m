...
signAcademicHonestyPolicy('Nehemie Pluviose', 'pluviose');
...
portrait_pts = [0 0; 400 0; 400 421; 0 421];
bg_pts = [121 21; 210 42; 210 421; 42 421];
...
% Test image stitching
% stitch three images
imgc = im2single(imread('hw3_pic.jpg'));
imgl = im2single(imread('flower_pic.jpg'));
imgr = im2single(imread('flower_pic.jpg'));
...
%figure, imshow(stitched_img);
imwrite(stitched_img, 'hw3_pic.jpg');
